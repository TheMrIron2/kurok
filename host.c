...
cvar_t	max_fps = {"max_fps", "65", true}; // MrG - max_fps
...
cvar_t	fraglimit = {"fraglimit","15",false,true};
cvar_t	timelimit = {"timelimit","15",false,true};
...
// MrG - max_fps
   ...
   if (max_fps.value < 1) Cvar_SetValue("max_fps", 65);
